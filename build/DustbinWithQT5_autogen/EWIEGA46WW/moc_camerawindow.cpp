...
QT_MOC_LITERAL(3, 30, 13), // "iValueChanged"
QT_MOC_LITERAL(4, 44, 0), // ""
QT_MOC_LITERAL(5, 45, 14), // "sStringChanged"
QT_MOC_LITERAL(6, 60, 11), // "camera_open"
QT_MOC_LITERAL(7, 72, 6), // "status"
QT_MOC_LITERAL(8, 79, 1), // "s"
QT_MOC_LITERAL(9, 81, 4), // "func"
QT_MOC_LITERAL(10, 86, 6), // "iValue"
QT_MOC_LITERAL(11, 93, 7) // "sString"

    },
    "CameraWindow\0QML.Element\0auto\0"
    "iValueChanged\0\0sStringChanged\0camera_open\0"
    "status\0s\0func\0iValue\0sString"
};
...
static const uint qt_meta_data_CameraWindow[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       6,    2,   38,    4, 0x0a /* Public */,

 // methods: name, argc, parameters, tag, flags
       9,    0,   43,    4, 0x02 /* Public */,
...
void CameraWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->camera_open((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        {
            using _t = void (CameraWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWindow::iValueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CameraWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWindow::sStringChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CameraWindow::iValueChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void CameraWindow::sStringChanged()
{
